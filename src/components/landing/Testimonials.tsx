...
const items = [
  ...
  {
    name: "Дамир С.",
    school: "Университет в Ханчжоу (стипендия)",
    initials: "ДС",
    text: "Я не понимал, с чего начать выбор провинции и вуза. За пару созвонов появилась чёткая стратегия, а через несколько месяцев пришло заветное приглашение и грант.",
  },
  {
    name: "Мадина Т.",
    school: "Университет в Гуанчжоу",
    initials: "МТ",
    text: "Дедлайны, документы, рекомендации — всё было под контролем. В Китае Риана всегда была на связи и помогла быстро освоиться.",
  },
];
